...
Ins = string(ARGS[1]) # string(parse(Int64,ARGS[1])) #"1"
#myFile = "/Users/din/Desktop/IntCVaR/Instances_Paper1/Instances for Additional Runs/"*dataSet*Ins*".jl"
myFile = "/Users/din/Desktop/IntCVaR/Instances/Instances_Created0630/N20Ins_"*Ins*".jl"
include(myFile)
...
if toUse == true && total_time >150 && total_time < 290
